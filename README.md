...
- ✨ <a class = "current-link" style="color: blue; text-decoration: none; font-family: 'Calibri', sans-serif;" href="https://github.com/VrindaJoshi/punnetsquare">a punnet square application</a> which calculates the genotypes and phenotypes of offspring
